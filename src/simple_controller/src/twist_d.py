...
while rospy.get_time() - start_time < 27.4:  # Run for 30 seconds in total
    twist = Twist()
    if rospy.get_time() - start_time < 7.4:  # Twist clockwise for 7.5 seconds
    ...
    elif rospy.get_time() - start_time < 24.9:  # Twist counterclockwise for 7 seconds
        twist.angular.z = 1.0  # Adjust the angular velocity as desired
    
    else:  # Reverse for 3 seconds
        twist.linear.x = -1.5  # Adjust the linear velocity as desired
