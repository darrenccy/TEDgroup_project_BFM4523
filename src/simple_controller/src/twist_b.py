...
while rospy.get_time() - start_time < 29.0:  # Run for 12 seconds in total
    twist = Twist()
    if rospy.get_time() - start_time < 6.9:  # Twist clockwise for 2 seconds
        twist.angular.z = 1.0  # Adjust the angular velocity as desired
    else:  # Move linearly for 10 seconds
